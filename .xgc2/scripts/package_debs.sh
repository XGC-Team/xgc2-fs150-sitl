...
PACKAGE="ros-${ROS_DISTRO}-xgc2-gazebo-sim-fs150-sitl"
ROS_PACKAGE="gazebo_sim_fs150_sitl"
...
Depends: python3, ros-${ROS_DISTRO}-gazebo-plugins, ros-${ROS_DISTRO}-xgc2-fs150-description (>= 0.1.0-11), ros-${ROS_DISTRO}-roslaunch, ros-${ROS_DISTRO}-mavros, ros-${ROS_DISTRO}-xgc2-gazebo-sim-px4-1-12 (>= 1.12.3-16)
